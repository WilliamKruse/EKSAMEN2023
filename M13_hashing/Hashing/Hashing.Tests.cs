...
namespace Hashing.Tests
{
    ...
    public class Hashing_Tests
    {
        ...
        public void TestAddChaining() {
            ...
            names.Add("Juliet");
            names.Add("Romeo");
            Assert.AreEqual(12, names.Size()); //Size-metoden inde fra koden. 12 er expected value & names.Size er actual.
        }
        ...
        public void TestContainsChaining() {
            ...
            names.Add("Juliet");
            names.Add("Romeo");
            Assert.IsTrue(names.Contains("Nina")); //Tester om det er true at disse personer er i listen. 
